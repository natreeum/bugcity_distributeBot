...
const companies = [
  ...
  },
  {
    ...
    members: [
      ...
      { userId: userData.msunny, level: 's' },
    ],
  },
  {
    // 양식
  ...
  },
  {
    ...
    members: [
      ...
      { userId: userData.caessaem, level: 's' },
      { userId: userData.heessugi, level: 's' },
      { userId: userData.dreamiroom, level: 's' },
    ],
  },
  {
    // 양식
  ...
  },
  {
    ...
    companyName: '커스텀스토어',
    members: [
      { userId: userData.martian, level: 'c' },
      { userId: userData.lua, level: 'e' },
      { userId: userData.chobom, level: 'e' },
      { userId: userData.michellemarine, level: 's' },
      { userId: userData.nalrari, level: 's' },
      { userId: userData.maksae, level: 's' },
      { userId: userData.reho, level: 's' },
    ],
  },
  {
  ...
  },
  {
    ...
    members: [
      ...
      { userId: userData.kumamo, level: 'e' },
      { userId: userData.metaluca, level: 'e' },
      { userId: userData.cos, level: 'e' },
      { userId: userData.dongbang, level: 'e' },
      { userId: userData.chobom, level: 's' },
      { userId: userData.gakabro, level: 's' },
      { userId: userData.michellemarine, level: 's' },
      { userId: userData.ella, level: 's' },
      { userId: userData.museoun, level: 's' },
      { userId: userData.huf, level: 's' },
      { userId: userData.jian, level: 's' },
      { userId: userData.hamaonni, level: 's' },
      { userId: userData.bugdisha, level: 's' },
      { userId: userData.nimporte, level: 's' },
      { userId: userData.clarabell, level: 's' },
    ],
  },
  {
    // 양식
